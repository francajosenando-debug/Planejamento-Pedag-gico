      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-5 my-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Planejamento BNCC no seu Celular
              </p>
            </div>
          </div>
        ...
        <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700/60 space-y-2 text-xs">
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
            ...
            <span>Acesso rápido direto da Tela de Início</span>
          </div>
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
            <CheckCircle className="w-4 h-4 text-emerald-500 flex-shrink-0" />
            <span>Funciona Offline e sem barra de navegação</span>
          </div>
          <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
            <ShieldCheck className="w-4 h-4 text-blue-500 flex-shrink-0" />
            <span>Compatível com Android e iPhone (iOS)</span>
          </div>
        </div>
        ...
        {installPrompt ? (
          <div className="space-y-3 pt-1">
            <button
              ...
              className="w-full py-3 px-4 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-extrabold text-xs shadow-lg shadow-blue-500/25 transition-all flex items-center justify-center gap-2"
            >
              <Download className="w-4 h-4" />
              <span>Instalar Agora no Aparelho</span>
            </button>
            <p className="text-[11px] text-center text-slate-400">
              Clique para confirmar a instalação nativa do aplicativo.
            </p>
          </div>
        ) : isIos ? (
          ...
          <div className="space-y-3 border-t border-slate-100 dark:border-slate-800 pt-3">
            ...
            <ol className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
              ...
              <li className="flex items-start gap-2.5 bg-slate-50 dark:bg-slate-800 p-2.5 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                ...
                <div>
                  Role as opções para baixo e toque em <strong className="text-slate-900 dark:text-white flex items-center gap-1 mt-0.5 inline-flex"><PlusSquare className="w-3.5 h-3.5 text-slate-700 dark:text-slate-200" /> "Adicionar à Tela de Início"</strong>.
                </div>
              </li>
          ...
          <div className="space-y-3 border-t border-slate-100 dark:border-slate-800 pt-3">
            <h4 className="text-xs font-extrabold text-slate-900 dark:text-white uppercase tracking-wider">
              Como instalar no Android / Computador
            </h4>
            <div className="text-xs text-slate-600 dark:text-slate-300 space-y-2 bg-slate-50 dark:bg-slate-800 p-3 rounded-2xl">
              <p>
                1. Abra o menu do seu navegador (três pontinhos no canto superior direito).
              </p>
              <p>
